...
class App {
    ...
    browser() {
        let browser = "BWAHAHAHA";
        return browser;
    }

    getallen(o, p) {
        
    let O = Math.log(o) + p + Math.pow(o, p);
    console.log(O)
    return O;
...
let o = app.getallen(88,2)
console.log(o)
let p = app.getallen(143, 0.5)
console.log(p)


app.runApplication();
app.newClassfunction();
app.anotherfunctionWithArguments("mijn argument is goed uitgelegd ");
app.marioLuigi();

let eindResultaat = app.browser();
